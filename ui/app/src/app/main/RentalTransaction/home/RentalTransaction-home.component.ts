...
@Component({
  selector: 'RentalTransaction-home',
  templateUrl: './RentalTransaction-home.component.html',
  styleUrls: ['./RentalTransaction-home.component.scss']
})
export class RentalTransactionHomeComponent implements AfterViewInit {
