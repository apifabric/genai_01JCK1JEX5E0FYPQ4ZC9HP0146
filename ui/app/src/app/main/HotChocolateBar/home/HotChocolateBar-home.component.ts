...
@Component({
  selector: 'HotChocolateBar-home',
  templateUrl: './HotChocolateBar-home.component.html',
  styleUrls: ['./HotChocolateBar-home.component.scss']
})
export class HotChocolateBarHomeComponent implements AfterViewInit {
