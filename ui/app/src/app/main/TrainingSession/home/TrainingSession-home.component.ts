...
@Component({
  selector: 'TrainingSession-home',
  templateUrl: './TrainingSession-home.component.html',
  styleUrls: ['./TrainingSession-home.component.scss']
})
export class TrainingSessionHomeComponent implements AfterViewInit {
