...
@Component({
  selector: 'SkiEquipment-home',
  templateUrl: './SkiEquipment-home.component.html',
  styleUrls: ['./SkiEquipment-home.component.scss']
})
export class SkiEquipmentHomeComponent implements AfterViewInit {
